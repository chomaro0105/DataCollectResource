...
/**
 * get을 통해 topic으로 부터 응답을 기다리는 로직이 존재.
 * 신뢰성 있는 운영이 가능
 */
public class ProducerSync {
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < 3; i++) {
                ProducerRecord<String, String> record = new ProducerRecord<>("gon-basic01", "Apache Kafka is a distributed streaming platform - " + i); //ProducerRecord 오브젝트를 생성합니다.
